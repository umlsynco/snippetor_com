(function ($) {
  ...
  $.fn.editable = function (options) {
    ...
    if (options == "disable") {
      ...
      return this.unbind(
        this.data("editable.options").editBy,
        this.data("editable.options").toEditable,
      );
    }
    ...
    if (this.data("editable.options")) return;
      ...
      if (opts.submit) {
        ...
        $this
          ...
          .one(opts.submitBy, function (e) {
            ...
            opts.toNonEditable(
              $(this).parent(),
              e.apply != undefined ? e.apply : true,
            );
          });
      // Cancel Event
      if (opts.cancel)
    ...
    options.toNonEditable = function ($this, change) {
      ...
      // Configure events,styles for changed content
      $this
        .one(opts.editBy, opts.toEditable)
        .data(
          "editable.current",
          change
